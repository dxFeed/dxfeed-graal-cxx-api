...
function(LinkStacktrace targetName)
    ...
    if (TARGET Boost::stacktrace_windbg)
        target_link_libraries(${targetName} PRIVATE Boost::stacktrace_windbg ole32 dbgeng)
    elseif (TARGET Boost::stacktrace_backtrace)
        target_link_libraries(${targetName} PRIVATE Boost::stacktrace_backtrace dl backtrace)
    ...
    elseif (TARGET Boost::stacktrace_addr2line)
        target_link_libraries(${targetName} PRIVATE Boost::stacktrace_addr2line dl)
    elseif (TARGET Boost::stacktrace_basic)
        target_link_libraries(${targetName} PRIVATE Boost::stacktrace_basic dl)
    else ()
        target_link_libraries(${targetName} PRIVATE Boost::stacktrace_noop)
    endif ()
endfunction()