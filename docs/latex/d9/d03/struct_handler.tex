\doxysubsection{Handler\texorpdfstring{$<$}{<} Signature \texorpdfstring{$>$}{>} Struct Template Reference}
\hypertarget{struct_handler}{}\label{struct_handler}\index{Handler$<$ Signature $>$@{Handler$<$ Signature $>$}}
