...
/* dxfg_auth_token_t* */ JavaObjectHandle<AuthToken>
createBasicToken(/* const char* */ const StringLikeWrapper &user, /* const char* */ const StringLikeWrapper &password);
...
/* dxfg_auth_token_t* */ JavaObjectHandle<AuthToken>
createCustomToken(/* const char* */ const StringLikeWrapper &scheme, /* const char* */ const StringLikeWrapper &value);
