...
/* const char* */ std::string getType(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setType
/* std::int32_t */ void setType(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                const StringLikeWrapper &value);

// dxfg_InstrumentProfile_getSymbol
/* const char* */ std::string getSymbol(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setSymbol
/* std::int32_t */ void setSymbol(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                  const StringLikeWrapper &value);
...
/* std::int32_t */ void setDescription(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                       const StringLikeWrapper &value);
...
/* std::int32_t */ void setLocalSymbol(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                       const StringLikeWrapper &value);
...
/* std::int32_t */ void setCountry(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                   const StringLikeWrapper &value);

// dxfg_InstrumentProfile_getOPOL
/* const char* */ std::string getOPOL(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setOPOL
/* std::int32_t */ void setOPOL(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                const StringLikeWrapper &value);
...
/* std::int32_t */ void setExchangeData(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                        const StringLikeWrapper &value);
...
/* std::int32_t */ void setExchanges(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                     const StringLikeWrapper &value);
...
/* std::int32_t */ void setCurrency(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                    const StringLikeWrapper &value);
...
/* std::int32_t */ void setBaseCurrency(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                        const StringLikeWrapper &value);

// dxfg_InstrumentProfile_getCFI
/* const char* */ std::string getCFI(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setCFI
/* std::int32_t */ void setCFI(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                               const StringLikeWrapper &value);

// dxfg_InstrumentProfile_getISIN
/* const char* */ std::string getISIN(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setISIN
/* std::int32_t */ void setISIN(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                const StringLikeWrapper &value);

// dxfg_InstrumentProfile_getSEDOL
/* const char* */ std::string getSEDOL(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setSEDOL
/* std::int32_t */ void setSEDOL(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                 const StringLikeWrapper &value);

// dxfg_InstrumentProfile_getCUSIP
/* const char* */ std::string getCUSIP(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setCUSIP
/* std::int32_t */ void setCUSIP(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                 const StringLikeWrapper &value);
...
/* std::int32_t */ void setICB(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                               std::int32_t value);
...
/* std::int32_t */ void setSIC(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                               std::int32_t value);
...
/* std::int32_t */ void setMultiplier(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                      double value);
...
/* std::int32_t */ void setProduct(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                   const StringLikeWrapper &value);
...
/* std::int32_t */ void setUnderlying(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                      const StringLikeWrapper &value);
...
/* std::int32_t */ void setSPC(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                               double value);

// dxfg_InstrumentProfile_getAdditionalUnderlyings
/* const char* */ std::string
getAdditionalUnderlyings(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);
...
/* const char* */ std::string getMMY(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setMMY
/* std::int32_t */ void setMMY(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                               const StringLikeWrapper &value);

// dxfg_InstrumentProfile_getExpiration
std::int32_t getExpiration(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setExpiration
/* std::int32_t */ void setExpiration(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                      std::int32_t value);

// dxfg_InstrumentProfile_getLastTrade
std::int32_t getLastTrade(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_setLastTrade
/* std::int32_t */ void setLastTrade(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                     std::int32_t value);
...
/* std::int32_t */ void setStrike(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                  double value);
...
/* std::int32_t */ void setOptionType(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                      const StringLikeWrapper &value);
...
/* std::int32_t */ void setTradingHours(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                        const StringLikeWrapper &value);

// dxfg_InstrumentProfile_getField
/* const char* */ std::string getField(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
                                       const StringLikeWrapper &name);

// dxfg_InstrumentProfile_setField
/* std::int32_t */ void setField(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
...
/* std::int32_t */ void setNumericField(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
...
/* std::int32_t */ void setDateField(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile,
...
getNonEmptyCustomFieldNames(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile> &instrumentProfile);

// dxfg_InstrumentProfile_release
// /* std::int32_t */ void release(/* dxfg_instrument_profile_t* */ const JavaObjectHandle<InstrumentProfile>& instrumentProfile);
