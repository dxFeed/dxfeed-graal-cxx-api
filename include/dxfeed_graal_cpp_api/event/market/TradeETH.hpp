 ...
 * both Trade and TradeETH events using @ref ::isExtendedTradingHours() "isExtendedTradingHours" method to figure out
 ...
 *     <b>double</b> extLast = tradeEth->@ref ::isExtendedTradingHours() "isExtendedTradingHours"() ? tradeEth->@ref
 * ::getPrice() "getPrice"() : trade->@ref Trade::getPrice() "getPrice"();
 * </tt></pre>
 *
 ...
 * @ref ::isExtendedTradingHours() "extendedTradingHours" property is internally represented as a last bit of the
 * "Flags" field of the record. Regional records do not explicitly store a field for @ref ::getExchangeCode()
